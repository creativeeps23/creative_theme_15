...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(this).on("click", "#header-navbar-change-lang .dropdown-item", function (event) {
            ...
            frappe.call({
                method: "creative_theme_15.api.change_language",
                args: {
        ...
        let AppLogoVM = new Vue({
            ...
            methods: {
                get_company_logo: function () {
                    const $this = this;
                    let logo = 'creative-new-logo.svg';
                    if ($('html').attr('data-theme-mode') == 'dark') {
                        logo = 'creative-new-logo-light.svg';
                    }
                    frappe.call({
                        type: 'POST',
                        method: 'creative_theme_15.api.get_company_logo',
                        args: {},
                        callback: async function (response) {
                            if (response.message && response.message.length) {
                                ...
                                $this.logo_class = '';
                                $this.logo_path = `/assets/creative_theme_15/images/${logo}`;
                            }
                        }
                    });
                }
        ...
        new Vue({
            ...
            methods: {
                get_current_language: function () {
                    const $this = this;
                    frappe.call({
                        method: "creative_theme_15.api.get_current_language",
                        args: {},
